...
növekmény = [l1[i-1] - l1[i] for i in range(1,len(l1))] # írd át
print(növekmény)
# index meghatározása
...
legnagyobb_különbség = max(különbség) # írd át
legnagyobb_különbség_id = különbség.index(legnagyobb_különbség) # írd át
print(legnagyobb_különbség)
print(legnagyobb_különbség_id)
...
harmincasok_átlaga = [a for a in l1 if a >= 30 and a < 40] / len([a for a in l1 if a >= 30 and a < 40])  # írd át
